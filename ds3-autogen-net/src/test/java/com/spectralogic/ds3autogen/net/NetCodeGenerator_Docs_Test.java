...
public class NetCodeGenerator_Docs_Test {
    ...
    @Test
    public void getBucketRequest_Test() throws IOException, ResponseTypeNotFoundException, ParserException, TypeRenamingConflictException, TemplateModelException {
