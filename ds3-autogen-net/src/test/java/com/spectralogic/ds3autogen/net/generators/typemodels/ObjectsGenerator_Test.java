...
public class ObjectsGenerator_Test {

    final static ObjectsGenerator generator = new ObjectsGenerator();
    ...
    public void toElementName_Test() {
        ...
        assertThat(generator.toElementName("Objects"), is("ObjectsList"));
        assertThat(generator.toElementName("ObjectsApiBean"), is("ObjectsApiBean"));
    }
}
