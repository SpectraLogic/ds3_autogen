...
/**
 * Generators for request payloads that have request payloads of Ds3PutObject
 */
public class Ds3PutObjectsPayloadGenerator extends AbstractObjectsPayloadGenerator {
