...
public class Ds3PutObjectPayloadGenerator_Test {

    private final Ds3PutObjectPayloadGenerator generator = new Ds3PutObjectPayloadGenerator();
    ...
    public void getPayloadConstructorArgTest() {
        ...
        assertThat(result.getType(), is("[]Ds3PutObject"));
    }
    ...
    public void getStructAssignmentVariableTest() {
        ...
        assertThat(result.getAssignment(), is("buildDs3PutObjectListStream(objects)"));
    }
}
