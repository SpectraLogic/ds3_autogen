...
public class Ds3VerifyObjectPayloadGenerator_Test {

    private final Ds3VerifyObjectPayloadGenerator generator = new Ds3VerifyObjectPayloadGenerator();
    ...
    public void getPayloadConstructorArgTest() {
        ...
        assertThat(result.getType(), is("[]Ds3VerifyObject"));
    }
    ...
    public void getStructAssignmentVariableTest() {
        ...
        assertThat(result.getAssignment(), is("buildDs3VerifyObjectListStream(objects)"));
    }
}
