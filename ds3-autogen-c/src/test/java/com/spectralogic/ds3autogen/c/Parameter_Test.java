...
public class Parameter_Test {
    ...
    public void testSetQueryParamSignatureDs3Bool() {
        ...
        assertThat(parmSig, is("void ds3_set_request_force(const ds3_request* request, const ds3_bool force)"));
    }
    ...
    public void testSetQueryParamSignatureString() {
        ...
        final String parmSig = ParameterHelper.generateSetQueryParamSignature(parm);
        assertThat(parmSig, is("void ds3_set_request_bucket_id(const ds3_request* request, const char* bucket_id)"));
    }
    ...
    public void testSetQueryParamSignatureUint64_t() {
        ...
        final String parmSig = ParameterHelper.generateSetQueryParamSignature(parm);
        assertThat(parmSig, is("void ds3_set_request_offset(const ds3_request* request, const uint64_t offset)"));
    }
    ...
    public void testSetQueryParamSignatureInt() {
        ...
        assertThat(parmSig, is("void ds3_set_request_offset(const ds3_request* request, const int max_keys)"));
    }
}
