...
public class StructHelper_Test {
    ...
    public void testStructMemberTypeStringToString() throws ParseException {
        ...
        assertThat(C_TypeHelper.convertDs3ElementType(testElement), is("ds3_str*"));
    }
    @Test
    ...
    public void testStructMemberTypeDoubleToString() throws ParseException {
        ...
        assertThat(C_TypeHelper.convertDs3ElementType(testElement), is("double"));
    }
    @Test
    public void testStructMemberTypeLongToString1() throws ParseException {
        ...
        assertThat(C_TypeHelper.convertDs3ElementType(testElement), is("uint64_t"));
    }
    @Test
    ...
    public void testStructTypeIntToString1() throws ParseException {
        ...
        assertThat(C_TypeHelper.convertDs3ElementType(testElement), is("int"));
    }
    @Test
    ...
    public void testStructTypeBooleanToString2() throws ParseException {
        ...
        assertThat(C_TypeHelper.convertDs3ElementType(testElement), is("ds3_bool"));
    }
    @Test
    public void testStructTypeDs3ResponseToString2() throws ParseException {
        ...
        assertThat(C_TypeHelper.convertDs3ElementType(testElement), is("ds3_build_information_response*"));
    }
